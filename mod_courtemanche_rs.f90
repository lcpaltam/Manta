...
!------------------------------------------------------------------------------!
  ...
  case (Courte_mod_CT_BBra)
    v_prm = (/ p_gNa, p_gCaL_CT_BBra, p_gto, p_gKur, p_gKr, p_gKs, p_gK1, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_RA/)
  case (Courte_mod_TVR)
    v_prm = (/ p_gNa, p_gCaL_TVR, p_gto, p_gKur, p_gKr_TVR, p_gKs, p_gK1, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_RA/)
  case (Courte_mod_RAA)
    v_prm = (/ p_gNa, p_gCaL_RAA, p_gto_RAA, p_gKur, p_gKr_RAA, p_gKs, p_gK1, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_RA/)
  case (Courte_mod_LA)
    v_prm = (/ p_gNa, p_gCaL_LA, p_gto, p_gKur, p_gKr_LA, p_gKs, p_gK1, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_LA/)
  case (Courte_mod_PV)
    v_prm = (/ p_gNa, p_gCaL_PV, p_gto_PV, p_gKur, p_gKr_PV, p_gKs_PV, p_gK1_PV, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_LA/)
  case (Courte_mod_LAA)
    v_prm = (/ p_gNa, p_gCaL_LAA, p_gto_LAA, p_gKur, p_gKr_LAA, p_gKs, p_gK1, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_LA/)   
  case (Courte_mod_MVR)
    v_prm = (/ p_gNa, p_gCaL_MVR, p_gto, p_gKur, p_gKr_MVR, p_gKs, p_gK1, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_LA/)
  case (Courte_mod_BBla)
    v_prm = (/ p_gNa, p_gCaL_BBla, p_gto, p_gKur, p_gKr_BBla, p_gKs, p_gK1, &
               p_gbCa, p_gbNa,p_ACh,p_IKACh_LA/)
  case default
    write (*,10) tcell; stop
  end select
